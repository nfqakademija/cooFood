 ...
 */
class Version20151125004224 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_event (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_event INT DEFAULT NULL, paid NUMERIC(10, 2) NOT NULL, accepted_user TINYINT(1) NOT NULL, accepted_host TINYINT(1) NOT NULL, INDEX IDX_D96CF1FF6B3CA4B (id_user), INDEX IDX_D96CF1FFD52B4B97 (id_event), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE order_item DROP FOREIGN KEY FK_52EA1F097CE67128');
        $this->addSql('ALTER TABLE order_item ADD CONSTRAINT FK_52EA1F097CE67128 FOREIGN KEY (id_user_event) REFERENCES user_event (id)');
    }
